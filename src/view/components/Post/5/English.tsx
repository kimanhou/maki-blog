        ...
        <PostTemplate postId={postId}
            ...
            <p>
                This method allows among other things to:<br></br>
                    <Cross/><span>vertically center a block inside its container</span><br></br>
                ...
                <br></br>
                More generally, it is easy to ensure that the items occupy the same place, in width and / or length, inside their container.
            </p>
            <p>
            ...
            <p>
                If you want to organize the container <span className={`code-element`}>div</span> into rows, that is to say divide it into several rows one above the other, you must give it a column direction. 
            ...
            <p>
                The container <span className={`code-element`}>div</span> is a flex container in row direction. 
            ...
            <div className={`code-sample`}>
            <span className={`color-vs-light-orange`}>.div-container</span> &#123;<br></br>
            ...
            <span className={`nbsp`}/>&gt;<span className={`color-vs-light-orange`}>.div-child</span> &#123;<br></br>
            ...
            <p>
                The latter allows you to add items of variable size without them overflowing the container <span className={`code-element`}>div</span>. 
                If the items do not fit on a row, they will automatically go to the row below.
            </p>
            <p>
            ...
            <p>
                You can also use the <i>width</i>  property: all items will have the same predefined width.
            </p>
            <p>
            ...
            <p>
                ...
                When you set <i>display: flex;</i> to a container, it also assigns other properties to its children and unlike other browsers, Safari's initial value of flex childrens for <i>align-items</i> is stretch, which breaks the ratio of the image.
                That is why, you need to set <i>align-self</i> to <i>flex-start</i>.
            </p>
            <div className={`code-sample`}>
            ...
            <p>
                If the parent of the image has a <span className={`code-element`}>flex-direction: column;</span>, you need to do this instead.
            </p>
            <div className={`code-sample`}>
            <span className={`color-vs-light-orange`}>image</span> &#123;<br></br>
